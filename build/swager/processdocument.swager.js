...
const errorMessages = {
    ...
    401: {
        ...
        detail: 'API key is missing or invalid. Please include a valid API key in the "x-api-key" header to access this endpoint.',
    },
    403: {
        title: "Forbidden - Invalid API key",
        detail: "Access denied. The provided API key is incorrect. Ensure you are using the correct API key to access this route.",
    },
};
const generateErrorResponses = (messages) => Object.fromEntries(Object.entries(messages).map(([status, { title, detail }]) => [
    status,
