...
const getContentDocumentId = async (sfConn, recordId, fileName) => {
    ...
    const response = await axios.get(`${sfConn.instanceUrl}/services/data/v57.0/query?q=${encodeURIComponent(query)}`, {
        headers: {
...
const createContentVersion = async (sfConn, fileContent, fileName, contentDocumentId) => {
    ...
    const response = await axios.post(`${sfConn.instanceUrl}/services/data/v57.0/sobjects/ContentVersion`, form, {
        headers: {
            Authorization: `Bearer ${sfConn.accessToken}`,
            ...form.getHeaders(),
        },
...
const linkContentDocument = async (sfConn, contentDocumentId, recordId) => {
    ...
    await axios.post(`${sfConn.instanceUrl}/services/data/v57.0/sobjects/ContentDocumentLink`, {
...
const uploadFileToSalesforce = async (sfConn, filePath, recordId, fileName = "Default") => {
    ...
    try {
        ...
        console.log(newContentDocumentId, "newContentDocumentId from uploadFileToSalesforce");
        if (!contentDocumentId) {
