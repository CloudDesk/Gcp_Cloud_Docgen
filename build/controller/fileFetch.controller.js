...
export const templateController = {
    ...
    async fetchTemplate(sfConn, contentVersionId, fileName) {
        try {
            ...
            const templateData = await fileFetchService.downloadAndSaveTemplate(fileName, contentVersionId, accessToken, instanceUrl);
...
//# sourceMappingURL=fileFetch.controller.js.map